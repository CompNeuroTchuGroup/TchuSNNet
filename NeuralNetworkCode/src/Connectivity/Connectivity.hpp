#ifndef _CONNECTIVITY_BASE_CLASS_HPP
#define _CONNECTIVITY_BASE_CLASS_HPP
...
protected:
  ...
  // std::vector<std::vector<signed long>> synapticTargets; //the list with postsynaptic (or target) neurons for each neuron of the presynaptic
  // population {array of pointer to vectors}
