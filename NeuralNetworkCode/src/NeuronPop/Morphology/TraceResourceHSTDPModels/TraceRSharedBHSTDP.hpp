...
class TraceRSharedBHSTDP : public BranchedMorphology {
...
public:
    ...
    //main Methods
    TraceRSharedBHSTDP()=default;
    explicit TraceRSharedBHSTDP(GlobalSimInfo* infoGlobal);
    ~TraceRSharedBHSTDP() override = default;
