...
CaDiffusionBranch::CaDiffusionBranch(std::vector<int> anteriorBranches, double gap, double branchLength, int branchId, TStepInt prespikeDelaySteps, Constants constants)
...
//         //ORDERING
//         // 4th calcineurin binding
//         nDot = constants.reaction3Ctt*(calcineurinTotal-CaResSpines.at(spineIndex).calcineurinActive)*CaResSpines.at(spineIndex).calmodulinActive - constants.reaction4Ctt*CaResSpines.at(spineIndex).calcineurinActive;
