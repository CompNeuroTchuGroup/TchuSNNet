...
private:
	...
	std::vector<std::vector<std::vector<NeuronInt>>> externalConnectivity;  // Postsynaptic neurons [to external presynaptic neuron i][in population Pi][list of its postsynaptic neurons in this population]
